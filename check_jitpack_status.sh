...
# 检查 burial-plugin
echo "🔍 检查 burial-plugin:2.0.13..."
response=$(curl -s -o /dev/null -w "%{http_code}" "https://jitpack.io/com/github/zhiying94/burial-plugin/2.0.13/burial-plugin-2.0.13.pom")
case $response in
    200)
